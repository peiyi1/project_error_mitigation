...
with open('../../data_experimental/extrapolation/list_counts_denominator_zz_crosstalk_measurement_crosstalk.json', 'r') as fl:
    list_counts_denominator=json.load(fl)
with open('../../data_experimental/extrapolation/list_counts_numerator_zz_crosstalk_measurement_crosstalk.json', 'r') as fl:
...
with open('../data_experimental/vd_cutting_measure_one_pauli_op_' +  str(pauli_op_index)  + '/cutting_result_denominator_measurement_crosstalk.json', 'w') as fl:
    json.dump(denominator,fl)
with open('../data_experimental/vd_cutting_measure_one_pauli_op_' +  str(pauli_op_index)  + '/cutting_result_numerator_measurement_crosstalk.json', 'w') as fl:
    json.dump(numerator,fl)
with open('../data_experimental/vd_cutting_measure_one_pauli_op_' +  str(pauli_op_index)  + '/cutting_result_ratio_measurement_crosstalk.json', 'w') as fl:
    json.dump(ratio,fl)
