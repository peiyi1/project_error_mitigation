...
with open('../../data_experimental/extrapolation/list_counts_denominator.json', 'r') as fl:
    list_counts_denominator=json.load(fl)
with open('../../data_experimental/extrapolation/list_counts_numerator.json', 'r') as fl:
