...
with open('../data_experimental/original_circuit/noise_exp.json', 'r') as fl:
        exp_ori_circ_noise=json.load(fl)
with open('../saved_results/exp_noise.json', 'w') as fl:
...
for pauli_string in paul_op:
    ...
    coef_index+=1
with open('../saved_results/exp_vd.json', 'w') as fl:
...
for pauli_string in paul_op:
    ...
    coef_index+=1
with open('../saved_results/exp_vd_extrapolation.json', 'w') as fl:
