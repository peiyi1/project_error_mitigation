...
interest_observable=tensor_product(obtain_matrix_i(),obtain_matrix_i(),obtain_matrix_z(),obtain_matrix_z())
...
interest_observable=tensor_product(obtain_matrix_i(),obtain_matrix_z(),obtain_matrix_z(),obtain_matrix_i())
denominator_1copy=np.trace(rho_ori@rho_ori).real
print(denominator_1copy)
numerator_1copy=np.trace(interest_observable@rho_ori@rho_ori).real
print(numerator_1copy)
...
interest_observable=tensor_product(obtain_matrix_z(),obtain_matrix_z(),obtain_matrix_i(),obtain_matrix_i())
denominator_1copy=np.trace(rho_ori@rho_ori).real
print(denominator_1copy)
numerator_1copy=np.trace(interest_observable@rho_ori@rho_ori).real
print(numerator_1copy)
